...
//funções - armazenar codigos para transformar em variavel
...
//eu quero q retorne as strings, n quero que retorne nd
vector<string> le_arquivo(){
    ...
    //se o arquivo for movido para uma pasta
    else{
